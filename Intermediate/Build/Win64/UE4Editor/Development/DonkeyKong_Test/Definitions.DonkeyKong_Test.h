...
#define UE_PROJECT_NAME DonkeyKong_Test
#define UE_TARGET_NAME DonkeyKong_TestEditor
#define UE_MODULE_NAME "DonkeyKong_Test"
...
#define DONKEYKONG_TEST_API DLLEXPORT
